            ...
            <nav class="navbar navbar-light bg-light ">
                <ul class="nav nav-tabs text-center col-12 border ">
                  ...
                  <li class="nav-item mx-1">
                    <a class="nav-link " href="patienturmsgs.php">Unread Messages</a>
                  </li>
                  <li class="nav-item mx-1">
                    <a class="nav-link active fw-bold" href="">Doctor's Available <!-- <span class="badge bg-secondary">4</span> --></a>
                  </li>
                </ul>
            </nav>
        </div>
                ...
                <div class="col-sm-12 col-md-8 col-lg-10 m-auto ">
                     <?php 
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                            <form id="form1" class=" p-3 col-12" method="POST" action="pmessenger.php">
                             <div class="row">
