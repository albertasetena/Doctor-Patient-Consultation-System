                            ...
                            <a class="nav-link active text-light" href="#"><i class="fas fa-users"></i> Manage Users</a>
                                <ul class="nav flex-column col-12  mx-4">
                                  ...
                                  <li class="nav-item  border-left">
                                    <a class="nav-link text-primary " aria-current="page" href="#"> <i class="fas fa-user-times"></i> Delete</a>
                                  </li>
                                </ul>
                          </li>
                                       ...
                                       <table class="table text-center table-bordered ">
                                            ...
                                            <?php
                                                ...
                                                while ($result = mysqli_fetch_array($resource)) 
                                                {
                                                    ...
                                                    echo "<td class=\" \">".$result[1]."</td>";
                                                    echo "<td class=\"text-start \"><a href=\"deluser.php?userid=".$result[0]."\"><button class=\"btn btn-outline-danger btn-sm\">Delete User</button></a></td>";
                                                    echo "</tr>";
                                                }
                                            ?>
                                        </table>             
