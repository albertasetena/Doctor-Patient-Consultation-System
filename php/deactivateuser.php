...
<head>
    <meta charset="utf-8">
    <title>Manage Users | De-activate</title>
                          ...
                          <li class="nav-item">
                            <a class="nav-link active text-light" href="#"><i class="fas fa-users"></i> Manage Users</a>
                                <ul class="nav flex-column col-12  mx-4">
                                  ...
                                  <li class="nav-item ">
                                    <a class="nav-link text-primary" aria-current="page" href="#"><i class="fas fa-user-minus"></i> De-Activate</a>
                                  </li>
                        ...
                        <div class="col-sm-12 col-md-10 col-lg-12  p-2  m-auto client-content-wrapper">
                            <div class="col-sm-8 col-md-12 col-lg-12 m-auto ">
                                <div class="col-sm-10 col-md-10 col-lg-12 text-center m-auto mb-3"><br>
                                    <p class="h6 text-start ">Active Users </p>
                                    <hr>
                                </div><br>
                                    ...
                                    <div class="col-sm-8 col-md-12 col-lg-12 m-auto table-scroller">
                                       <table class="table text-center table-bordered ">
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM users WHERE category<>'3' AND  status='active'";
                                                ...
                                                while ($result = mysqli_fetch_array($resource)) 
                                                {
                                                    ...
                                                    echo "<td>".$result[1]."</td>";
                                                    echo "<td><a href=\"deactive.php? userid=".$result[0]."\"><button class=\"btn btn-outline-primary btn-sm\">Deactive User</button></a></td>";
                                                    echo "</tr>";
                                                }
                                            ?>
                                        </table>             
